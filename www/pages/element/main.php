...
function pages_main_element_menu()
{
	...
	*/
    ...
    <div class="app-sidebar">
				<div class="logo">
					<a style="width:50px;height:50px;border-radius: unset; background: url(' . Url::$favicon . ') no-repeat;background-size: 90%;" class="logo-icon"><span style="white-space: nowrap;" class="logo-text">СтудГородок</span></a>
					<div class="sidebar-user-switcher user-activity-online">
						<a href="#">
							<img src="' . $GLOBALS['user']['img_url'] . '">
							<span class="activity-indicator"></span>
							<span class="user-info-text">' . $GLOBALS['user']['first_name'] . '<br><span class="user-state-info">' . $statusTitle . '</span></span>
						</a>
					</div>
				</div>
				...
				<div class="app-menu">
					<ul class="accordion-menu" id="menu_mod">
						...
						<li><a href="' . Url::$path . '/system/auth/logout/"><i class="material-icons">logout</i>Выйти</a></li>
						' . $admin . '
						<li></li>
					</ul>
				</div>
